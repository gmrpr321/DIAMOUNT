      ...
      <div className='flex flex-row w-screen h-screen'>
        ...
        <div className='flex flex-row left-1/4 top-28 shadow-bx bg-white h-4/6 w-2/4 absolute'>
          <div className='basis-1/2 flex flex-col'>
            ...
            <div className='flex flex-col ml-10 xl:mt-6 2xl:mt-8'>
            ...
            <div className='flex flex-row ml-12 mt-6'>
              ...
              <div className='xl:text-xs 2xl:text-sm font-medium'>or</div>
              <hr className='basis-5/12 h-0.5 my-auto' color='black'></hr>
            </div>
            <div className='mt-6 mx-auto shadow-bx h-8 w-fit rounded-md cursor-pointer flex flex-row'>
              ...
              <div className='text-md font-semibold my-auto mr-2'>Continue with Google</div>
            </div>
